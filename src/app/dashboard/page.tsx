      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col">
          <main className="flex-grow p-6">
            <h2 className="text-center text-blue-900 text-2xl font-bold mb-6">
              DASHBOARD
            </h2>

            <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 mb-8">
              <Card label="TOTAL" value={total?.length} center />
              <Card
                label="6° ANO"
                value={(
            ...
            <h2 className="text-center text-green-900 text-2xl font-bold mb-4">
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-lg p-4 text-center border-2 ${
        green ? "border-green-600" : "border-blue-900"
      }`}
    >
...
function ChartCard({
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 h-80 border border-gray-200">
      <div className="text-sm font-bold text-gray-600 mb-2 text-center uppercase">
        {title}
      </div>
      {children}
    </div>
