  ...
  useEffect(() => {
    if (candidato && !formData?.nome) {
      setFormData(prev => ({
        ...
        dataNascimento: candidato.Nasc ? new Date(candidato.Nasc).toISOString().split('T')[0] : '',
        sexo: candidato.Sexo || '',
        ...
        dataNascimentoResponsavel: candidato.NascResp ? new Date(candidato.NascResp).toISOString().split('T')[0] : '',
