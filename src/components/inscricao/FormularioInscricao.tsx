...
const FormularioInscricao: React.FC<any> = ({
  isAcompanhamento,
  primeiroCad,
  checkboxMarcado,
  setCheckboxMarcado,
  ...
  return (
    <>
      <form
        ...
        className="max-w-4xl mx-auto bg-white shadow rounded-lg p-6 space-y-8"
      >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <input
                disabled={isAcompanhamento || session?.user?.cpf}
                readOnly={isAcompanhamento}
                maxLength={14}
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <input
                disabled={isAcompanhamento || session?.user.birthdate}
                readOnly={isAcompanhamento || session?.user.birthdate}
                type="date"
                name="dataNascimento"
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <select
                name="sexo"
                value={formData?.sexo === "M" ? "masculino" : "feminino"}
                onChange={handleChange}
                className={baseInput}
                disabled={isAcompanhamento}
              >
                <option value="">
                  {isAcompanhamento ? formData.sexo : "Selecione"}
                </option>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className={`${baseInput} ${
                  !podeEditarExtras ? "bg-gray-100 cursor-not-allowed" : ""
                }`}
              >
                <option value="">
                  {isAcompanhamento ? formData.tipoCota || "" : "Selecione"}
                </option>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              >
                <option value="">
                  {isAcompanhamento ? formData.parentesco : "Selecione"}
                </option>
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              >
                <option value="">
                  {isAcompanhamento ? formData.ramoForcas : "Selecione"}
                </option>
                <option value="">Não</option>
                <option value="X">Sim</option>
              </select>
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <input
                ...
                onChange={handleChange}
                className={baseInput}
                disabled={isAcompanhamento || session?.user?.email}
                readOnly={isAcompanhamento}
              />
            </div>
            {primeiroCad && (
              <div className="col-span-12 md:col-span-4">
                <label className="text-red-800 font-medium mb-1 block">
                  Solicitar Isenção
                </label>
                <select
                  name="isencao"
        ...
        {primeiroCad && (
          <label className="flex items-center justify-center mb-4 text-red-700">
            <input
              ...
              className="mr-2"
            />
            Candidato declara não ter sido excluído, por motivo disciplinar, por
            qualquer CM
          </label>
        )}
            ...
            {provisoryUser && provisoryKey && (
              <>
                <p className="text-red-800">
                  Dados provisórios de acesso, Login:{" "}
                  <span className="font-bold">{provisoryUser}</span> Senha:{" "}
                  <span className="font-bold">{provisoryKey}</span>
                </p>
                <p className="text-red-800 text-sm">
                  Não compartilhe essa informação com ninguém.
                </p>
              </>
            )}
            {paymentButton && (
              <button
                ...
                className="bg-green-800 hover:bg-green-950 text-white font-semibold py-3 px-8 rounded mt-2"
              >
                Ir para pagamento
              </button>
            )}
