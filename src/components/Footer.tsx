...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-blue-900 text-white flex flex-col md:flex-row justify-between items-start px-6 py-4">
      <div className="flex items-start">
        {/* Mapa do Google ajustado */}
        <iframe
          title="Mapa"
          width="240"
          height="80"
      ...
      <div className="text-sm mt-4 md:mt-0 md:ml-6 text-center">
        ...
        <button className="bg-yellow-400 text-black font-semibold px-6 py-2 rounded-full hover:bg-yellow-500 transition"onClick={LoginPage}>ENTRAR</button>
      </div>
    </footer>
  );
};
