...
import UserStatsCardImageCropper from './UserStatsCardImageCropper';
import { IoMdClose } from "react-icons/io";

export default function UserStatsCardChangeImageModal({
  closeModal,
  updateAvatar,
}: any) {
    ...
    <div
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-[750px] justify-center px-2 py-12 text-center ">
          <div
            className="relative w-[60%] sm:w-[80%] min-h-[60vh] rounded-2xl bg-white-light text-black-all text-left shadow-xl transition-all"
            ref={modalRef}>
