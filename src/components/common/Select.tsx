  ...
  ({ className, error, onFocusRemoveError, options, onChange, title, showPlaceholderOption = false, ...props }, ref) => {
    ...
    return (
      <select
        ...
        {...props}
        className={cn(
          "select border-0 border-transparent outline-none bg-white-medium rounded-[15px] text-black-dark font-normal text-base input-placeholder w-full shadow-custom py-1 transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
          {
